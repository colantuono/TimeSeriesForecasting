...
hc <- highchart(type = "chart") %>% 
  hc_title( text = paste0('Faturamento Passado')
  ...
  hc_tooltip( crosshairs = TRUE, borderWidth = 3, sort = TRUE, table = TRUE, valueDecimals = 0
    ...
    hc_add_series(type = "line"
                ...
                , data = list_parse2(data.frame( value = as.numeric(fat$valor_final_item)))) %>%
...
total_fat <-  c(fat$valor_final_item, PREVISAO)
