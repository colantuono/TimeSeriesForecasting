---
title: "Previsão de Faturamento por Semana"
---
...
### AQUI DA ERRO
oos_plot <- as.numeric(  c(pred_oos$pred) + c(out_of_sample_t_s) # - c(pred_oos$se)    
                         ) 
...
PREVISAO <- ts(PREVISAO_remainder$pred, frequency=52) + ts(PREVISAO_t_s$pred, frequency=52) #+ ts(PREVISAO_remainder$se, frequency=52) + ts(PREVISAO_t_s$se, frequency=52) 
